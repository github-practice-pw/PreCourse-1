/*
 * Implementing Singly linked list [LIFO]
 *
 * Time Complexity : 
 ...
 * 3. Set the new node's 'next' pointer according to the required function.
 * 4. Update the head of the list to be the required node.
 */
